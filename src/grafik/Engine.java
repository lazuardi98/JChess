...
public class Engine implements ActionListener
{
    ...
    public Engine(String title, boolean exitOnClose) {
        try {
        ...
        this.frame.setLocation(screenWidth / 4, screenHeight / 7);
        if (exitOnClose) {
    ...
    protected void addButton(String label, Object receiver, String funcName, Layout layout) {
    ...
    protected void addButton(String label, String funcName, Layout layout) {
        this.addButton(label, this, funcName, layout);
    }

    protected void addRadioButton(String label, String groupName, boolean selected, Object receiver, String funcName, Layout layout) {
    ...
    protected void add(Widget widget, Layout layout) {
        this.frame.add((Component)widget.me, layout.params);
    }

    protected void addLabel(String text, String id, Layout layout) {
        if (this.labelMap.containsKey(id)) {
            throw new IllegalArgumentException("duplicate id: " + id);
        }
        Font font = new Font("Serif", Font.BOLD + Font.ITALIC, 17);
        JLabel label = new JLabel(text);
        label.setFont(font);
        this.labelMap.put(id, label);
        label.setPreferredSize(new Dimension(470, 29));
    ...
    protected void addLabel(String text, Layout layout) {
